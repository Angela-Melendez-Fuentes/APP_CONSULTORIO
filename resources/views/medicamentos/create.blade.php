<x-app-layout>
    ...
    <div class="container mx-auto max-w-screen-md p-8 bg-white rounded shadow-md mt-20">
        <h3 class="text-lg font-bold mb-4">Agregar Nuevo Medicamento</h3>
        ...
        <form action="{{ route('medicamentos.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nombre" name="nombre" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required>
            </div>

            <div class="mb-4">
                <label for="descripcion" class="block text-sm font-medium text-gray-700">Descripción</label>
                <input type="text" id="descripcion" name="descripcion" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required>
            </div>

            <div class="mb-4">
                <label for="precio" class="block text-sm font-medium text-gray-700">Precio</label>
                <input type="number" step="0.01" id="precio" name="precio" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" required>
            </div>
            ...
            <div class="text-right">
                ...
                <button type="submit" class="bg-green-500 text-black px-4 py-2 rounded">Guardar Medicamento</button>
            </div>
        </form>
    </div>
</x-app-layout>
