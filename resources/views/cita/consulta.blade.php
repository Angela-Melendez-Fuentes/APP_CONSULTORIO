        ...
        <script>
            ...
            function addMedicationRow() {
                ...
                row.innerHTML = `
                    ...
                    <input type="text" name="cantidades[]" class="w-full p-2 border rounded" placeholder="Cantidad">
                ...
                <div class="mt-8">
                    ...
                    <div class="vital-signs">
                        ...
                        <div class="vital-sign">
                            ...
                            <p><input type="number" id="talla" name="talla" value="{{ $cita->talla }}" class="w-20 h-10 p-2 border rounded"></p>
                            <p>Talla (cm)</p>
                        </div>
                        <div class="vital-sign">
                            <img src="{{ asset('images/icono-tem.png') }}" alt="temperatura" style="width: 50px; max-width: 100%;">
                            <p><input type="number" id="temperatura" name="temperatura" value="{{ $cita->temperatura }}"  class="w-20 h-10 p-2 border rounded"></p>
                            <p>Temperatura (°C)</p>
                        </div>
                        <div class="vital-sign">
                            <img src="{{ asset('images/icono-peso.png') }}" alt="peso" style="width: 50px; max-width: 100%;">
                            <p><input type="number" id="peso" name="peso" value="{{ $cita->peso }}"  class="w-20 h-10 p-2 border rounded"></p>
                            <p>Peso (kg)</p>
                        </div>
                        <div class="vital-sign">
